"""
评估模型PPL的独立脚本
用法: python eval_ppl.py <model_path> --base_model <tokenizer_path> --dataset <dataset>
"""
...
def opt_eval(model, testenc, dev):
    ...
    for i in range(len(layers)):
        print(f'  Layer {i}/{len(layers)-1}', end='\r')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--base_model', type=str, required=True, help='Path to base model (for tokenizer)')
